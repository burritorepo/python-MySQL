...
INSERT INTO `bdcotizaciones`.`productos` (`nomprod`, `abreprod`, `fechaven`, `estado`, `codeusu`, `fechaalta`) VALUES ('Honeywell Granit 1280i', 'HG1280i', '2030-04-27', '1', '1', '2019-04-27');
INSERT INTO `bdcotizaciones`.`productos` (`nomprod`, `abreprod`, `fechaven`, `estado`, `codeusu`, `fechaalta`) VALUES ('Honeywell Granit 1910i', 'HG1910i', '2030-04-27', '1', '1', '2019-04-27');
